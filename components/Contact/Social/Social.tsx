    ...
    >
      ...
      <div className="mx-auto flex flex-grow flex-col justify-center py-[100px] xl:container lg:py-[50px]">
        ...
        <div className="mt-8 flex flex-col items-center justify-evenly gap-y-4 text-[0.85rem] lg:mt-16 lg:flex-row lg:text-[0.75rem] xl:text-[0.85rem]">
          ...
          >
            <SocialSection
              icon="/images/icons/github-dark.svg"
              iconBg="/images/contact/social/blob-1.svg"
              iconSize={35}
              title={t('githubTitle')}
              handle="@Ronitydv"
              link="https://github.com/Ronitydv"
              text={t('github')}
            />
          </Transition>
          ...
          >
            <SocialSection
              ...
              iconSize={45}
              title={t('emailTitle')}
              handle="rao.yadav.ronit@gmail.com"
              link="mailto:rao.yadav.ronit@gmail.com"
              text={t('email')}
            />
          </Transition>
        </div>
